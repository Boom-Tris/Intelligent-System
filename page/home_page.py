...
def display_home():
    ...
    st.markdown('<p class="text_indent">1. Decision Tree – โมเดลที่ไม่เป็นเชิงเส้น (Non-linear) ที่ทำการแบ่งข้อมูลเป็นกลุ่มย่อยๆ ตามค่าของคุณลักษณะต่างๆ เพื่อให้สามารถตัดสินใจได้ โมเดลนี้สามารถอธิบายการตัดสินใจได้ง่ายและเหมาะสำหรับการทำความเข้าใจวิธีการที่โมเดลตัดสินใจจากข้อมูลที่ป้อนเข้าไป </p>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="text_indent">2. K-Nearest Neighbors (KNN) – โมเดลที่ง่ายแต่มีประสิทธิภาพ โดยการจัดประเภทข้อมูลใหม่ๆ ขึ้นอยู่กับความใกล้เคียงของข้อมูลนั้นกับข้อมูลในชุดฝึกฝน โมเดลนี้เชื่อมโยงสมมติฐานที่ว่า สิ่งที่คล้ายกันมักจะอยู่ใกล้เคียงกัน </p>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="text_indent">3. Support Vector Regression (SVR) – เทคนิคการถดถอย (Regression) ที่มุ่งหาค่าที่ดีที่สุดในขณะที่อนุญาตให้มีขอบเขตของข้อผิดพลาด โดย SVR เหมาะสมกับข้อมูลในมิติสูงและเมื่อมีความสัมพันธ์ที่ไม่เป็นเชิงเส้นระหว่างข้อมูล </p>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="text_indent">5. Neural Networks – โมเดลที่ได้รับแรงบันดาลใจจากสมองมนุษย์ ใช้สำหรับการจดจำลวดลายและการทำนายผล Neural Networks เป็นโมเดลที่มีความยืดหยุ่นสูงและสามารถจับความสัมพันธ์ที่ซับซ้อนได้จากข้อมูล </p>', unsafe_allow_html=True)
